...
Docker images to run a Terraria Server. Latest 1.4.2.2 images with [Vanilla Server](https://terraria.gamepedia.com/Server) are available.
...
* vanilla-1.4.2.2, vanilla-latest, latest [(containers/vanilla/1.4.2.2/Dockerfile)](https://github.com/dereckhall/terraria/blob/master/containers/vanilla/1.4.2.2/Dockerfile)
